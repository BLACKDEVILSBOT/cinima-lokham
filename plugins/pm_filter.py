...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            InlineKeyboardButton('📋 Group', url=f'http://t.me/cimimalokham')
            ],[
            InlineKeyboardButton('🔍 Search', switch_inline_query_current_chat=''),
            InlineKeyboardButton('🕵‍♂️ Dev', url='https://t.me/Ciminalokham)
            ],[
        ...
        buttons= [[
            InlineKeyboardButton('🥳 Group', url='https://t. me/Ciminalokham'),
